                            ...
                            child: Padding(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      AppTextField(
                                        ...
                                        validator: (value) {
                                          if (auth.firstNameController.text
                                              .isEmpty) {
                                            return "this_field_can_t_be_empty"
                                                .tr;
                                          }
                                      ...
                                      AppTextField(
                                        ...
                                        validator: (value) {
                                          if (auth.lastNameController.text
                                              .isEmpty) {
                                            return "this_field_can_t_be_empty"
                                                .tr;
                                          }
                                      ...
                                      TextFormField(
                                        ...
                                        validator: (value) {
                                          if (auth.addressController.text
                                              .isEmpty) {
                                            return "this_field_can_t_be_empty"
                                                .tr;
                                          }
                              ...
                              FilteringTextInputFormatter.allow(RegExp("[0-9].")),
                                      ...
                                      SizedBox(height: 70,
                                          child:
                                          ButtonGlobal(
                                              buttontext: 'register_my_account'
                                                  .tr,
